...
--
-- Host: 127.0.0.1    Database: elsys_A_10
-- ------------------------------------------------------
...
INSERT INTO `channel` VALUES (1,'Test',1),(2,'Test',2),(3,'Test',3);
...
INSERT INTO `user` VALUES (1,'Test','Tester',0),(2,'Testov','New Tester',0),(3,'Tested','Next Tester',0);
...
CREATE TABLE `userChannels` (
  ...
  CONSTRAINT `userChannels_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `userChannels_ibfk_2` FOREIGN KEY (`channel_id`) REFERENCES `channel` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `userChannels` VALUES (1,1,1),(2,2,2),(3,3,3);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER VideosInsert
AFTER INSERT
ON video
FOR EACH ROW
	UPDATE user 
...
--
-- Dumping events for database 'elsys_A_10'
--

--
-- Dumping routines for database 'elsys_A_10'
--
...
-- Dump completed on 2019-04-17 11:52:53
