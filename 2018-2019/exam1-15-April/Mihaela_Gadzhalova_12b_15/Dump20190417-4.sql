...
INSERT INTO `Battle` VALUES (1,3,4),(2,5,6),(3,1,2);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER Create_Update_Wins after insert on Battle for each row
begin
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER Update_Update_Wins after update on Battle for each row
begin
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER Delete_Update_Wins after delete on Battle for each row
begin
    update House h set h.Number_of_wins = h.Number_of_wins - 1 where h.Id = old.Winner_id;
end */;;
DELIMITER ;
...
INSERT INTO `House` VALUES (1,'dvustaen',0),(2,'tristaen',0),(3,'maze',0);
...
INSERT INTO `Person` VALUES (1,'Sasho',1),(2,'Toni',2),(3,'Bibi',3),(4,'Valio',2),(5,'Vladi',3),(6,'Dani',1);
...
-- Dump completed on 2019-04-17 13:23:54
